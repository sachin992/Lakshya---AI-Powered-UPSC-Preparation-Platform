...
#     st.session_state.puzzle_page = "quiz_type"  # quiz_type, category, difficulty, game
...
#     "History & Culture": {
#         "Beginner": [
#             {"q": "Who was the first President of India?", "options": ["Dr. Rajendra Prasad", "Dr. S. Radhakrishnan", "C. Rajagopalachari", "Sardar Vallabhbhai Patel"], "correct": "A"},
#             {"q": "In which year did India gain independence?", "options": ["1945", "1947", "1950", "1952"], "correct": "B"},
#         ],
#         "Intermediate": [
#             {"q": "The term 'two-state solution' is sometimes mentioned in the news in the context of the affairs of", "options": ["A) China", "B) Israel", "C) Iraq", "D) Yemen"], "correct": "B"},
#         ],
#         "Advanced": [
#             {"q": "Which dynasty ruled India for the longest period?", "options": ["Maurya", "Gupta", "Mughal", "British"], "correct": "C"},
#         ]
#     },
#     "Geography": {
#         "Beginner": [
#             {"q": "Which is the longest river in India?", "options": ["Brahmaputra", "Ganges", "Godavari", "Yamuna"], "correct": "B"},
#         ],
#         "Intermediate": [
#             {"q": "The Western Ghats are located in which direction from the Deccan Plateau?", "options": ["North", "South", "East", "West"], "correct": "D"},
#         ],
#         "Advanced": [
#             {"q": "Which mountain range separates India from Tibet?", "options": ["Aravalli", "Himalayas", "Nilgiris", "Satpura"], "correct": "B"},
#         ]
#     }
# }
...
#     st.markdown(
#         "<h1 style='text-align: center; color: #1e40af;'>UPSC PYQ Question Sweeper</h1>",
#         unsafe_allow_html=True
#     )
    
#     st.markdown(
#         "<p style='text-align: center; font-size: 16px;'>Test your UPSC knowledge with this unique quiz-puzzle game using real Previous Year Questions!</p>",
#         unsafe_allow_html=True
#     )
    
#     st.markdown(
#         "<p style='text-align: center; color: #666;'>Find hidden question blocks by using clues that show how many question blocks are nearby.</p>",
#         unsafe_allow_html=True
#     )
    
#     st.markdown(
#         "<p style='text-align: center;'><a href='#' style='color: #1e40af;'>ⓘ How to Play</a></p>",
#         unsafe_allow_html=True
#     )
...
#     with col1:
#         if st.button(
#             "General Studies\n\nHistory, Geography, Polity & More",
#             use_container_width=True,
#             key="gs_btn",
#             help="General Studies Questions"
#         ):
...
#     # Display categories as buttons in 3 columns
...
#     # Create grid with some questions randomly placed
...
#             st.divider()
#             st.button("Submit Answer", use_container_width=True, disabled=True)
...
#     st.markdown("<p style='text-align: center;'><a href='#' style='color: #1e40af;'>ⓘ How to Play</a></p>", unsafe_allow_html=True)
#     st.divider()
#     st.markdown("<h2 style='text-align: center; color: #1e40af;'>Choose Paper Type</h2>", unsafe_allow_html=True)
